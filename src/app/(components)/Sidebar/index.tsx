...
import { setIsSidearCollapsed } from '@/app/state'
import { Archive, CircleDollarSign, Clipboard, LayoutIcon, LucideIcon, Menu, Settings, User } from 'lucide-react'
...
const Sidebar = () => {
  ...
  const toggleSidebar = () => {
    dispatch(setIsSidearCollapsed(!isSidebarCollapsed));
  }
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5" : "px-8"}`}>
        ...
        <button className='md:hidden px-3 py-3 bg-gray-100 rounded-full hover:bg-blue' onClick={toggleSidebar}>
